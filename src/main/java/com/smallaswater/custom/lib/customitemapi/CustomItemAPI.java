package com.smallaswater.custom.lib.customitemapi;
 ...
 * @author LT_Name
 */
public class CustomItemAPI implements Listener{

    private Plugin plugin;

    public CustomItemAPI(Plugin plugin){
        this.plugin = plugin;
        customItemAPI = this;
    }
    ...
    public void registerCustomItem(int id, @NotNull Class<? extends ItemCustom> c) {
        ...
        try {
            ...
            plugin.getLogger().error("register custom item error!", e);
        }
    ...
    private void generatePalette() {
        try {
            ...
            plugin.getLogger().error("generate palette error!", e);
        }
    }
